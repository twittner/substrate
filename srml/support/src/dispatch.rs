...
macro_rules! decl_module {
	...
	(
		$(#[$attr:meta])*
		pub struct $mod_type:ident<$trait_instance:ident: $trait_name:ident$(<Instance>, Instance: Instantiable $(= $module_default_instance:path)?)?>
		...
		decl_module!(@normalize
			$(#[$attr])*
			pub struct $mod_type<$trait_instance: $trait_name$(<Instance>, Instance $(= $module_default_instance)?)?>
	...
	(@normalize
		$(#[$attr:meta])*
		pub struct $mod_type:ident<$trait_instance:ident: $trait_name:ident$(<Instance>, Instance $(= $module_default_instance:path)?)?>
		for enum $call_type:ident where origin: $origin_type:ty, system = $system:ident
		{}
		{ $( $on_initialise:tt )* }
		{ $( $on_finalise:tt )* }
	...
	(@normalize
		$(#[$attr:meta])*
		pub struct $mod_type:ident<$trait_instance:ident: $trait_name:ident$(<Instance>, $instance:ident $(= $module_default_instance:path)?)?>
		for enum $call_type:ident where origin: $origin_type:ty, system = $system:ident
		{ $( $deposit_event:tt )* }
		{ $( $on_initialise:tt )* }
		{ $( $on_finalise:tt )* }
	...
	(@impl_deposit_event
		$module:ident<$trait_instance:ident: $trait_name:ident$(<Instance>, Instance)?>;
		$system:ident;
	) => {};

	(@impl_deposit_event
		$module:ident<$trait_instance:ident: $trait_name:ident$(<Instance>, $instance:ident)?>;
		$system:ident;
	...
	(@imp
		...
		decl_module! {
			@impl_on_initialise
			$mod_type<$trait_instance: $trait_name $(<Instance>, $instance)?>;
			$( $on_initialise )*
		}
		...
		$(
			decl_module! {
				@impl_function
				$mod_type<$trait_instance: $trait_name $(<Instance>, $fn_instance)?>;
				$origin_type;
				$from;
				$fn_vis fn $fn_name (
		...
		$crate::__dispatch_impl_metadata! {
			$mod_type<$trait_instance: $trait_name $(<Instance>, $instance)?> $call_type $origin_type
...
macro_rules! __dispatch_impl_metadata {
	(
		$mod_type:ident<$trait_instance:ident: $trait_name:ident$(<Instance>, $instance:ident)?>
		$($rest:tt)*
	) => {
		impl<$trait_instance: $trait_name $(<Instance>, $instance: 'static + Instantiable)?> $mod_type<$trait_instance $(, $instance)?> {
